...
public:
  virtual ~MediaCodecDataDecoderCallback();
  MediaCodecDataDecoderCallback();
...
protected:
  ...
  virtual nsresult Output(mozilla::widget::android::BufferInfo* aInfo, void* aBuffer) { return NS_OK; }
  virtual nsresult PostOutput(mozilla::widget::android::BufferInfo* aInfo) { return NS_OK; }
